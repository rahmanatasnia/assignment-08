...
const AllApps = ({ data }) => {
    ...
    return (
        <div>
            ...
            <p className='text-[#627382] text-center mt-4 lg:mb-10'>Explore All Trending Apps on the Market developed by us</p>
            ...
            <div className='text-center'>
                <button className='bg-gradient-to-r from-[#632EE3] to-[#9F62F2] w-[250px] h-[50px] rounded-[8px] text-white font-semibold text-xl mt-15 mb-20 hover:bg-purple-300 hover:scale-95'>Show All</button>
